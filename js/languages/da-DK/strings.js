...
strings[lang] = {
    ...
    'see-all-notes-button': 'Se alle noter og indstillinger',
    'clear-all-notes-confirmation': 'Er du sikker på, at du vil rydde alle data?\nDu kan ikke annullere processen, når først den er startet.',
    ...
    'clear-notes-of-this-page-button': 'Ryd denne note',
    'show-content-button': 'Vis indhold',
    'copy-notes-button': 'Kopiér',
    'edit-notes-button': 'Rediger',
    'finish-edit-notes-button': 'Afslut redigering',
    'red-colour': 'Rød',
    'yellow-colour': 'Gul',
    'black-colour': 'Sort',
    'grey-colour': 'Grå',
    ...
    'save-on-local-instead-of-sync': 'Gem dine data lokalt, eller brug en Notefox-konto i stedet for at synkronisere med en Firefox-konto',
    'save-on-local-instead-of-sync-detailed': 'I version 3.3 gemte tilføjelsen automatisk noter på din Firefox-konto i stedet for lokalt.\nNår aktiveret, deaktiveres synkronisering, og lagring på lokal enhed genindføres.\nDet anbefales at <b>aktivere denne indstilling</b>',
    ...
    'advanced-managing': 'Avancerede håndtering af URL\'er',
    'advanced-managing-detailed': 'Når denne indstilling er aktiveret, kan du også gemme noter pr. "under-domæne", f.eks.: <span class=\'url-small\'>https://eksempel.side/a-side/*</span>, <span class=\'url-small\'>https://eksempel.side/a-side/anden-side/*</span>.',
    ...
    'save-page-content': 'Gem også sideindhold',
    ...
    'check-with-all-supported-protocols': 'Tjek noteseksistens med alle understøttede protokoller',
    'check-with-all-supported-protocols-detailed': 'Når aktiveret, tjekkes noter for alle understøttede protokoller. For eksempel, hvis du er på en side med <b>https</b>-protokol, tjekker tilføjelsen noter for både <b>http-</b> og <b>https</b>-protokoller.',
    'font-family': 'Skrifttypefamilie: vælg den skrifttypefamilie, der skal bruges til noteteksten',
    ...
    'theme-choose-lighter-select': 'Lysere',
    'theme-choose-light-select': 'Lys',
    'theme-choose-dark-select': 'Mørk',
    'theme-choose-darker-select': 'Mørkere',
    ...
    'sticky-theme-detailed-text': 'Hvis du vælger {{property1}} betyder det, at temaet ikke er optimeret til tilføjelsen selvom det vil forsøge at bruge det samme tema korrekt.',
    ...
    'sticky-theme-choose-lime-select': 'Limegrøn',
    'sticky-theme-choose-cyan-select': 'Cyan',
    'sticky-theme-choose-pink-select': 'Lyserød',
    'sticky-theme-choose-white-select': 'Lysegrå',
    'sticky-theme-choose-black-select': 'Mørkegrå',
    ...
    'cancel-link-button': 'Annuller',
    'delete-link-button': 'Delete link',
    'edit-link-text': 'Edit or delete the link for the selected text',
    'edit-link-button': 'Save',
    'all-notes-aside': 'Alle noter',
    'help-aside': 'Hjælp',
    'settings-aside': 'Indstillinger',
    'review-aside': 'Review',
    'donate-aside': 'Køb mig en kaffe',
    'website-aside': 'Website',
    'translate-aside': 'Oversæt',
