...
strings[lang] = {
    ...
    'clear-all-notes-button': 'すべてのデータを消去',
    ...
    'sticky-theme-detailed-text': '{{property1}} を選択した場合、テーマは同じテーマを正しく使用しようとしますが、アドオンに最適化されていないことを意味します。',
    ...
    'email-textbox': 'Eメールアドレス',
    'username-textbox': 'ユーザー名',
