...
strings[lang] = {
    ...
    'see-all-notes-button': 'Zobacz wszystkie notatki i ustawienia',
    'clear-all-notes-confirmation': 'Czy na pewno chcesz usunąć wszystkie dane? Nie możesz anulować tego procesu po jego uruchomieniu.',
    ...
    'clear-notes-of-this-page-button': 'Usuń tę notatkę',
    'show-content-button': 'Pokaż zawartość',
    'copy-notes-button': 'Kopiuj',
    'edit-notes-button': 'Edytuj',
    'finish-edit-notes-button': 'Zakończ edycję',
    'red-colour': 'Czerwony',
    'yellow-colour': 'Żółty',
    'black-colour': 'Czarny',
    'grey-colour': 'Szary',
    ...
    'save-on-local-instead-of-sync': 'Zapisz swoje dane lokalnie lub użyj konta Notefox zamiast synchronizacji z kontem Firefoksa',
    ...
    'advanced-managing': 'Zaawansowane zarządzanie adresami URL',
    'advanced-managing-detailed': 'Po włączeniu możesz zapisać notatki również dla "poddomeny", takie jak: <span class=\'url-small\'>https://example.page/a-page/*</span>, <span class=\'url-small\'> https://example.page/a-page/other-page/*</span>.',
    ...
    'save-page-content': 'Zapisz również zawartość strony',
    ...
    'disable-confirmation-popup-detailed': 'Po włączeniu nie zobaczysz wyskakujących okienek potwierdzenia podczas usuwania notatek. <b>Uważaj:</b> usunięte notatki nie mogą zostać odzyskane.',
    ...
    'change-icon-color-based-on-tag-colour': 'Zmień kolor ikonki w zależności od koloru tagu',
    ...
    'text-size-detailed': 'Możesz wybrać rozmiar tekstu notatek.',
    'extra-small-text-size': 'Bardzo mały',
    'small-text-size': 'Mały',
    'standard-text-size': 'Standardowy',
    'large-text-size': 'Duży',
    'extra-large-text-size': 'Bardzo duży',
    ...
    'theme-choose-lighter-select': 'Jaśniejszy',
    'theme-choose-light-select': 'Jasny',
    'theme-choose-dark-select': 'Ciemny',
    'theme-choose-darker-select': 'Ciemniejszy',
    ...
    'insert-link-button': 'Wstaw odnośnik',
    ...
    'website-aside': 'Strona internetowa',
    'translate-aside': 'Przetłumacz',
    ...
    'appearance-title-settings': 'Wygląd',
    ...
    'notefox-account-settings': 'Konto Notefox',
    ...
    'notefox-account-button-settings-manage': 'Zarządzaj kontem',
    'notefox-account-button-settings-logout': 'Wyloguj się',
    'notefox-account-button-settings-delete': 'Usuń konto',
    ...
    'notefox-account-button-settings-login-or-signup': 'Zaloguj się lub Zarejestruj się',
    'notefox-account-button-settings-change-password': 'Zmień hasło',
    'notefox-account-button-settings-password-changed': 'Zmiana hasła zakończyła się powodzeniem.',
    ...
    'notefox-account-button-verify-email': 'Zweryfikuj e-mail',
    'notefox-account-button-resend-email': 'Uzyskaj nowy kod',
    ...
    'notefox-account-login-expired-title': 'Sesja wygasła',
    ...
    'notefox-account-message-error-499': 'Nieznany błąd.',
    'notefox-account-message-unknown': 'Nieznany błąd.',
    ...
    'notefox-account-message-button1': 'Wyloguj się',
    'notefox-account-message-button2': 'Kontynuuj w trybie offline',
    'title-notes-placeholder': 'Tytuł strony…',
    ...
    'password-textbox': 'Hasło',
    'password-confirm-textbox': 'Potwierdź hasło',
    'old-password-textbox': 'Stare hasło',
    'new-password-textbox': 'Nowe hasło',
    'new-password-confirm-textbox': 'Potwierdź nowe hasło',
    'verification-code-textbox': 'Kod weryfikacyjny',
    ...
    'empty-fields-alert': 'Aby kontynuować, wypełnij wszystkie pola.',
