...
strings[lang] = {
    ...
    'clear-all-notes-button': 'Εκκαθάριση όλων των δεδομένων',
    ...
    'sticky-theme-detailed-text': 'Αν επιλέξετε {{property1}} αυτό σημαίνει ότι το θέμα δεν είναι βελτιστοποιημένο για το πρόσθετο αν και θα προσπαθήσει να χρησιμοποιήσει το ίδιο θέμα σωστά.',
    ...
    'cancel-link-button': 'Ακύρωση',
    'delete-link-button': 'Delete link',
    'edit-link-text': 'Edit or delete the link for the selected text',
    'edit-link-button': 'Save',
    'all-notes-aside': 'Όλες οι σημειώσεις',
    'help-aside': 'Βοήθεια',
    'settings-aside': 'Ρυθμίσεις',
    'review-aside': 'Review',
    'donate-aside': 'Αγοράστε μου έναν καφέ',
    'website-aside': 'Website',
    'translate-aside': 'Μετάφραση',
