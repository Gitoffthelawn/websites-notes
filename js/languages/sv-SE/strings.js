...
strings[lang] = {
    ...
    'clear-all-notes-button': 'Rensa all data',
    ...
    'sticky-theme-detailed-text': 'Om du väljer {{property1}} betyder detta att temat inte är optimerat för tillägget även om det kommer att försöka använda samma tema korrekt.',
    ...
    'sticky-theme-choose-auto-select': 'Följ Firefox tema',
    ...
    'all-notes-aside': 'Alla anteckningar',
    'help-aside': 'Hjälp',
    'settings-aside': 'Inställningar',
    'review-aside': 'Review',
    'donate-aside': 'Köp mig ett kaffe',
    'website-aside': 'Website',
    'translate-aside': 'Översätt',
    'version-aside': 'Notefox {{version}}',
    'general-title-settings': 'Allmänt',
    'advanced-title-settings': 'Avancerat',
