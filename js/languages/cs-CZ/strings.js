...
strings[lang] = {
    ...
    'clear-all-notes-button': 'Vymazat všechna data',
    ...
    'sticky-theme-detailed-text': 'Pokud zvolíte {{property1}} , znamená to, že téma není optimalizováno pro doplněk, i když se pokusí použít stejný motiv správně.',
    ...
    'cancel-link-button': 'Zrušit',
    'delete-link-button': 'Delete link',
    'edit-link-text': 'Edit or delete the link for the selected text',
    'edit-link-button': 'Save',
    'all-notes-aside': 'Všechny poznámky',
    'help-aside': 'Nápověda',
    'settings-aside': 'Nastavení',
    'review-aside': 'Review',
    'donate-aside': 'Koupit mi kávu',
    'website-aside': 'Website',
    'translate-aside': 'Překlad',
    'version-aside': 'Notefox {{version}}',
    'general-title-settings': 'Obecné',
    'advanced-title-settings': 'Pokročilé',
    ...
    'email-textbox': 'E-mailová adresa',
    'username-textbox': 'Uživatelské jméno',
