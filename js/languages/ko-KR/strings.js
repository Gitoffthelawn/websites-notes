...
strings[lang] = {};
strings[lang] = {
    'all-notes-title': '모든 노트',
    'all-notes-title-page': 'NoteFox - 모든 노트',
    'export-all-notes-button': '………………',
    'export-notes-to-file-button': '바로 파일 내보내기',
    ...
    'clear-all-notes-button': '모든 데이터 삭제',
    ...
    'imported-button': '읽어옴',
    'export-json-message-dialog-text': '새 JSON(또는 텍스트) 파일을 만들고 <strong>이것을 수정하지 않음</strong> 아래 코드를 붙여넣습니다 (코드를 복사하기 위하여 <span {{parameters}}>지금 복사</span> 버튼을 클릭합니다.).',
    'copy-now-button': 'Copy now',
    'last-update-text': 'Last update: {{date_time}}',
    'page-label': '페이지',
    'domain-label': '도메인',
    'global-label': 'Global',
    'see-all-notes-button': '모든 노트와 설정 보기',
    'clear-all-notes-confirmation': '모든 데이터를 삭제하시겠습니까?\n이 작업은 되돌릴 수 없습니다.',
    ...
    'title-label': '제목',
    'copied-button': '복사됨',
    'clear-all-notes-of-this-domain-button': '이 도메인에 있는 모든 노트 지우기',
    'no-notes-found-text': '노트를 찾지 못했습니다',
    'clear-notes-of-this-page-button': '이 노트 지우기',
    'show-content-button': 'Show content',
    'copy-notes-button': '복사',
    'edit-notes-button': '수정하기',
    'finish-edit-notes-button': '수정 완료',
    'red-colour': '빨강색',
    'yellow-colour': '노란색',
    'black-colour': '검정색',
    'grey-colour': '회색',
    ...
    'review-on-firefox-addons-button': '추가 기능 평가',
    'saved-button': '저장 완료',
    'save-button': '저장',
    'open-popup-by-default': '기본적인 팝업 열기    ',
    'consider-parameters': 'Consider parameters as part of the url page',
    'consider-parameters-detailed': '활성화 했을때: <span class=\'url-small\'>https://example.page/search?query=test</span> is different to <span class=\'url-small\'>https://example.page/search</span>',
    'consider-sections': 'Consider sections as part of the url page',
    'consider-sections-detailed': '활성화시: <span class=\'url-small\'>https://example.page/search#section1</span> is different to <span class=\'url-small\'>https://example.page/search</span>',
    ...
    'theme-choose-light-select': '밝음',
    'theme-choose-dark-select': '어두움',
